...
%capid = 10;
localization = read_sha(strcat('Data/Cap', num2str(capid),'_coef4.out'),1);
...
%[Tebest,Tesd,rhotbest,rhotsd,fbest,fsd] = MCMC_flexure_VolcanicMontes([0 300],[2200 3300],[0 1],25,60,0.05,5000,1000,degs,FADM,FADM_sd2,capid,degmin,degmax);
timeused = toc; 
disp 'MCMC finished'
disp(['Time used is ' num2str(timeused/60) ' minutes']);
%!move tmp.mat Cap16_3.mat
%eval(['!move tmp.mat VallesMarineris3_3para_' num2str(degmin) num2str(degmax) '.mat']);