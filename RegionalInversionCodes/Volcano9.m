...
set(gca,'Ytick',-100:50:260,'ylim',[0 120],'Xtick',0:20:120,'xlim',[Lwin+5 max(degs)],'YMinorTick','on','XMinorTick','on')
...
eval(['!move tmp.mat Volcano9_Alba_3para_' num2str(degmin) num2str(degmax) '.mat']);
