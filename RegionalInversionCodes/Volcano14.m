...
set(gca,'Ytick',-100:50:260,'ylim',[70 170],'Xtick',0:20:120,'xlim',[Lwin+5 max(degs)],'YMinorTick','on','XMinorTick','on')
...
% eval(['!move tmp.mat Volcano14_Elysium_3para_' num2str(degmin) num2str(degmax) '.mat']);
