...
%capid = 10;
localization = read_sha(strcat('Data/Cap', num2str(capid),'_coef3.out'),1);
...
%% Important!!! To consistent with the situation for Valles Marineris, 
%I need to add rhoc = rhot in mcgovern_synthetic_admcor.m
% clear;
% capid = 16;
...
% 
% tic                                                    
% MCMC_flexure_VolcanicMontes_tponly([0 200],[2000 3300],20,100,2000,200,degs,FADM,FADM_sd2,capid,degmin,degmax);
% timeused = toc; 
% disp 'MCMC finished'
% disp(['Time used is ' num2str(timeused/3600) ' hours']);
% !move tmp.mat Cap16_tponly.mat
...
%[Tebest,Tesd,rhotbest,rhotsd,fbest,fsd] = MCMC_flexure_VolcanicMontes([0 300],[2200 3300],[0 1],30,67,0.1,10000,2000,degs,FADM,FADM_sd2,capid,degmin,degmax);
timeused = toc; 
disp 'MCMC finished'
disp(['Time used is ' num2str(timeused/60) ' minutes']);
%!move tmp.mat Cap16_2.mat
%eval(['!move tmp.mat VallesMarineris2_3para_' num2str(degmin) num2str(degmax) '.mat']);