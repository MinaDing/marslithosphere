...
load Cap2_SP_3para_FixRhot_15.mat
degmin = 35;
degmax = 45;
...
xlim([0 300])
set(gca,'YMinorTick','on','XMinorTick','on','Xtick',0:50:300,'Ytick',0:0.02:0.8,'Layer','top')
...
set(gca,'Xtick',0:100:300,'XMinorTick','on','Ytick',-1:0.5:1,'YMinorTick','on','Layer','top')
ylabel '\alpha'
xlabel 'Te (km)'
xlim([0 300])
ylim([-1 1])
...
set(gca,'Xtick',0:5:10,'XMinorTick','on','Ytick',-1:0.5:1,'YMinorTick','on','Layer','top','Yticklabel',[])
xlabel 'f'
xlim([0 10])
ylim([-1 1])
...
[counts,centers]=hist(X(3,burnin:N),-1:bw:1);
[f,xi,bw] = ksdensity(X(3,burnin:N),-1:bw:1);
barh(centers,counts/sum(counts),'FaceColor',[0.7 0.7 0.7],'EdgeColor','none');
line(f*bw,xi,'color','r','linewidth',1);
ylim([-1 1])
set(gca,'YMinorTick','on','XMinorTick','on','Ytick',-1:0.5:1,'Yticklabel',[])
set(gca, 'Layer', 'top')
xlim([0 0.08])
