...
disp(['Posterior range normalized=' num2str(mean(faa_sd)/mean(FAAvec_sd))]);

subplot1(2)
xlim([0 theta])
errorbar(Dvec,TOPOvec,TOPOvec_sd,'k')
initialvec = fun([7 [a (1-a)*0.5]*theta],Dvec);
plot(Dvec,initialvec,'k--');
...
print(['Argyre_spatial_cov.pdf'],'-dpdf')
