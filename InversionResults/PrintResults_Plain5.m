...
FCOR_sdi = FCOR_sd;
capid = 5;
load Cap5_AT_3para_2230_10.mat
degmin = 22;
degmax = 30;
...
set(gca,'Xtick',2000:500:3300,'XMinorTick','on','Ytick',0:2:6,'YMinorTick','on','Layer','top','Yticklabel',[])
xlabel '\rho_t (kg/m^3)'
xlim([2200 3300]);
ylim([0 5])
...
[counts,centers]=hist(X(3,burnin:N),0:bw:10);
[f,xi,bw] = ksdensity(X(3,burnin:N),0:bw:10);
barh(centers,counts/sum(counts),'FaceColor',[0.7 0.7 0.7],'EdgeColor','none');
line(f*bw,xi,'color','r','linewidth',1);
ylim([0 5])
set(gca,'YMinorTick','on','XMinorTick','on','Ytick',0:2:4,'Yticklabel',[])
set(gca, 'Layer', 'top')
