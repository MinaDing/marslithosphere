...
capid = 7;
%load Cap7_TC_3para_2230_10.mat;degmin = 22;degmax = 30;
load Cap7_TC_3para_4173_25.mat;degmin = 41;degmax = 73;
...
set(gca,'Xtick',2000:250:3300,'XMinorTick','on','Ytick',0:2:6,'YMinorTick','on','Layer','top','Yticklabel',[])
xlabel '\rho_t (kg/m^3)'
xlim([2200 3300]);
ylim([0 5])
